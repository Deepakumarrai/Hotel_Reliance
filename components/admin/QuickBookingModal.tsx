              ...
              <div className="bg-white p-4 sm:p-5 rounded-2xl border border-[#E8DFD2] space-y-4 shadow-2xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      <option value="single">Single Occupancy (₹{roomPrices.single || 2310}/nt)</option>
                      <option value="double">Double Occupancy (₹{roomPrices.double || 2625}/nt)</option>
                      <option value="triple">Family Room (₹{roomPrices.triple || 3360}/nt)</option>
                    </select>
                  </div>
