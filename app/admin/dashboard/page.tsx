  ...
  return (
    <AdminLayout>
      <div className="space-y-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gradient-to-r from-[#111E31] via-[#1B2A42]/60 to-[#111E31] p-6 rounded-2xl border border-[#1B2A42] shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#9E712E]/5 rounded-full blur-3xl pointer-events-none" />

          <div>
            <span className="text-[11px] uppercase tracking-[0.2em] font-bold text-[#C4984F] block">
              Hotel Reliance Control Center
            </span>
            <h1 className="text-2xl sm:text-3xl font-serif font-bold text-white mt-1">
              Good Morning, {adminName}
            </h1>
            <p className="text-xs text-[#E9DFD2]/60 mt-1">
              Co-operative Colony, Bokaro Steel City • {totalRoomsCount} Rooms Active ({availableRooms} Ready)
            </p>
          </div>
          ...
          <div className="flex items-center space-x-3">
            <Link
              href="/admin/bookings"
              className="px-4 py-2.5 rounded-xl bg-[#1B2A42] hover:bg-[#253755] text-xs font-semibold text-[#D8B875] border border-[#C4984F]/30 transition-colors flex items-center space-x-1.5 shadow-sm"
            >
            ...
            <Link
              href="/admin/rooms"
              className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-[#9E712E] to-[#C4984F] hover:from-[#8C6326] hover:to-[#B38740] text-xs font-bold uppercase tracking-wider text-white shadow-lg transition-all flex items-center space-x-1.5 active:scale-95"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <KPIStatCard
            ...
            value={`${occupancyRate}%`}
            subtitle={`${occupiedRooms} of ${totalRoomsCount} rooms occupied`}
            trend="4.2%"
            trendUp={true}
          ...
          <KPIStatCard
            ...
            subtitle={`₹${pendingRevenue.toLocaleString()} pending collection`}
            trend="14.8%"
            trendUp={true}
        ...
        <div className="bg-[#0B1423] border border-[#1B2A42] p-5 rounded-2xl shadow-xl">
          <span className="text-[10px] uppercase font-bold tracking-widest text-[#C4984F] block mb-3">
            Quick Operational Actions
          </span>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            <Link
              href="/admin/pricing"
              className="p-3 rounded-xl bg-[#111E31] border border-[#1B2A42] hover:border-[#C4984F]/50 text-center transition-all group"
            >
              <Sliders className="w-4 h-4 text-[#D8B875] mx-auto mb-1.5 group-hover:scale-110 transition-transform" />
              <span className="text-xs font-semibold text-white block">Tariff Rates</span>
              <span className="text-[10px] text-white/40">Edit Prices</span>
            </Link>
            <Link
              href="/admin/availability"
              className="p-3 rounded-xl bg-[#111E31] border border-[#1B2A42] hover:border-[#C4984F]/50 text-center transition-all group"
            >
              <BedDouble className="w-4 h-4 text-[#D8B875] mx-auto mb-1.5 group-hover:scale-110 transition-transform" />
              <span className="text-xs font-semibold text-white block">Availability</span>
              <span className="text-[10px] text-white/40">Matrix View</span>
            </Link>
            <Link
              href="/admin/staff"
              className="p-3 rounded-xl bg-[#111E31] border border-[#1B2A42] hover:border-[#C4984F]/50 text-center transition-all group"
            >
              <Users className="w-4 h-4 text-[#D8B875] mx-auto mb-1.5 group-hover:scale-110 transition-transform" />
              <span className="text-xs font-semibold text-white block">Staff Roster</span>
              <span className="text-[10px] text-white/40">Manage Team</span>
            </Link>
            <Link
              href="/admin/banquet"
              className="p-3 rounded-xl bg-[#111E31] border border-[#1B2A42] hover:border-[#C4984F]/50 text-center transition-all group"
            >
              <Sparkles className="w-4 h-4 text-[#D8B875] mx-auto mb-1.5 group-hover:scale-110 transition-transform" />
              <span className="text-xs font-semibold text-white block">Banquets</span>
              <span className="text-[10px] text-white/40">Venues & Quotes</span>
            </Link>
            <Link
              href="/admin/restaurant"
              className="p-3 rounded-xl bg-[#111E31] border border-[#1B2A42] hover:border-[#C4984F]/50 text-center transition-all group"
            >
              <CircleDollarSign className="w-4 h-4 text-[#D8B875] mx-auto mb-1.5 group-hover:scale-110 transition-transform" />
              <span className="text-xs font-semibold text-white block">Kwality Menu</span>
              <span className="text-[10px] text-white/40">Dishes & Tables</span>
            </Link>
            <Link
              href="/admin/settings"
              className="p-3 rounded-xl bg-[#111E31] border border-[#1B2A42] hover:border-[#C4984F]/50 text-center transition-all group"
            >
              <ShieldCheck className="w-4 h-4 text-[#D8B875] mx-auto mb-1.5 group-hover:scale-110 transition-transform" />
              <span className="text-xs font-semibold text-white block">Hotel Settings</span>
              <span className="text-[10px] text-white/40">Contact & Info</span>
            </Link>
          </div>
        </div>

        {/* Secondary Indicators / Inventory Breakdown */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
          ...
          <div className="bg-[#111E31] border border-[#1B2A42] p-4 rounded-xl text-center">
            <span className="text-[10px] uppercase font-bold text-[#E9DFD2]/60">Occupied</span>
            <div className="text-xl font-bold text-blue-400 mt-1">{occupiedRooms}</div>
            <span className="text-[10px] text-white/40">In-House Guests</span>
          </div>
          <div className="bg-[#111E31] border border-[#1B2A42] p-4 rounded-xl text-center">
            <span className="text-[10px] uppercase font-bold text-[#E9DFD2]/60">Housekeeping</span>
            <div className="text-xl font-bold text-cyan-400 mt-1">{cleaningRooms}</div>
            <span className="text-[10px] text-white/40">Cleaning Active</span>
          </div>
          <div className="bg-[#111E31] border border-[#1B2A42] p-4 rounded-xl text-center">
          ...
          <div className="bg-[#111E31] border border-[#1B2A42] p-4 rounded-xl text-center col-span-2 sm:col-span-1">
            <span className="text-[10px] uppercase font-bold text-[#E9DFD2]/60">Pending Actions</span>
            <div className="text-xl font-bold text-amber-400 mt-1">{pendingBookings.length}</div>
            <span className="text-[10px] text-white/40">Awaiting Approval</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 bg-[#0B1423] border border-[#1B2A42] rounded-2xl p-6 shadow-xl space-y-4">
            <div className="flex items-center justify-between border-b border-[#1B2A42] pb-4">
              <div className="flex items-center space-x-2.5">
                <div className="w-8 h-8 rounded-lg bg-emerald-950 border border-emerald-500/40 flex items-center justify-center text-emerald-400 shadow-sm">
              ...
              <span className="px-2.5 py-1 rounded-full bg-emerald-950/80 border border-emerald-500/30 text-emerald-400 text-xs font-bold">
                      ...
                      <tr key={arrival.id} className="hover:bg-[#111E31]/50 transition-colors">
                        ...
                        <td className="py-3 text-right">
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold text-[11px] shadow-sm transition-all cursor-pointer"
                          >
                            Check-In
                          </button>
                        </td>
          ...
          <div className="lg:col-span-5 bg-[#0B1423] border border-[#1B2A42] rounded-2xl p-6 shadow-xl space-y-4">
            <div className="flex items-center justify-between border-b border-[#1B2A42] pb-4">
              <div className="flex items-center space-x-2.5">
                <div className="w-8 h-8 rounded-lg bg-amber-950 border border-amber-500/40 flex items-center justify-center text-amber-400 shadow-sm">
              ...
              <span className="px-2.5 py-1 rounded-full bg-amber-950/80 border border-amber-500/30 text-amber-400 text-xs font-bold">
                      ...
                      <tr key={departure.id} className="hover:bg-[#111E31]/50 transition-colors">
                        ...
                        <td className="py-3 text-right">
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-[11px] shadow-sm transition-all cursor-pointer"
                          >
                            Check-Out
                          </button>
                        </td>
                  ...
                  <tr key={booking.id} className="hover:bg-[#111E31]/50 transition-colors">
                    ...
                    <td className="py-3.5 text-right space-x-2">
                      <Link
                        ...
                        className="px-2.5 py-1 rounded-md bg-[#1B2A42] hover:bg-[#253755] text-white text-[11px] font-medium transition-colors"
                      >
                        View
                      </Link>
                      ...
                      {booking.bookingStatus === "CHECKED_IN" && (
                        <button
                          ...
                          className="px-2.5 py-1 rounded-md bg-blue-600 hover:bg-blue-500 text-white text-[11px] font-bold transition-colors cursor-pointer"
                        >
                          Check-Out
                        </button>
                      )}
                      {booking.bookingStatus !== "CANCELLED" && booking.bookingStatus !== "CHECKED_OUT" && (
                        <button
                          ...
                          className="px-2.5 py-1 rounded-md bg-rose-950 hover:bg-rose-900 text-rose-300 text-[11px] transition-colors cursor-pointer"
                        >
                          Cancel
                        </button>
                      )}
